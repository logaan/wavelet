...
_(fill in: pre-scan vs inline decision and why, where registration happens, how
the native/wasm32 split was handled in the reader, and what hook you left for
Step 8's aliasing/qualified resolution.)_
